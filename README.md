...
- Para os argumentos `Saturday` e `C9:00-AM` deve lançar uma exccolor-guesseção com a mensagem: `'The hour should represent a number'`;
...
## Instalação e Uso
1. Faça o clone do repositório: ```git clone git@github.com:matheusfgb2/zoo-functions.git```

2. Navegue até o diretório do projeto: ```cd zoo-functions```

3. Para executar testes: ``npm test`` ou ``npm test:coverage`` para executar a cobertura de testes
